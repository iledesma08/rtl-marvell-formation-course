//Reutilizamos el módulo del TP anterior
...
logic signed [width_P-1:0] a_signado; //Para calcular su C2 por si es necesario para el algoritmo
logic signed [width_B:0] b_signado; //Para calcular su C2 por si es necesario. Sin -1 en ambas para manejar el caso extremo
logic signed [width_B:0] b_radix_2; // es par agregarle el cero adelante
...
logic signed [width_P-1:0] a_extendido; //lo extiendo para shiftearlo -- Corrección con respecto al anterior
